...
<style>
  ...
  .mono { font-family: 'JetBrains Mono', 'SF Mono', Monaco, Menlo,
          Consolas, 'Courier New', monospace !important;
          font-weight: 500 !important; letter-spacing: -0.01em !important;
          font-size: 13px !important; }
  .mono-lg { font-family: 'JetBrains Mono', 'SF Mono', Monaco, Menlo,
             Consolas, 'Courier New', monospace !important;
             font-weight: 600 !important; letter-spacing: -0.02em !important;
             font-size: 14px !important; color: var(--text) !important; }
  .mono-sm { font-family: 'JetBrains Mono', 'SF Mono', Monaco, Menlo,
             Consolas, 'Courier New', monospace !important;
  ...
  .badge-manual { display: inline-block;
                  ...
                  font-size: 9px; font-weight: 800;
                  padding: 2px 7px; border-radius: 6px; }
  .badge-mismatch { display: inline-block;
        ...
        with ui.element('div').style(
            ...
            with ui.element('div').style("flex:1;min-width:0;"):
                ...
                if item.get("location_hint"):
                    ui.label(str(item["location_hint"])).classes(
                        "mono-sm"
                    )
                cit = []
